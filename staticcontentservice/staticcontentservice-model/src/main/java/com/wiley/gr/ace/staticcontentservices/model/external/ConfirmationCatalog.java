 ...
 */
public class ConfirmationCatalog {
     ...
     *
     * @param confirmationMessages the confirmation messages
     */
    public final void setConfirmationMessages(
            HashMap<String, String> confirmationMessages) {
