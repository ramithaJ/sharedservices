...
public class SearchServiceImpl implements SearchService {
	...
	public Response search(SearchCriteria searchCriteria, String role) {
		...
		requestBuilder = setFilter(requestBuilder, searchCriteria);
	...
	private SearchRequestBuilder setFilter(SearchRequestBuilder requestBuilder,
	 ...
	 * @return
	 */
	private SearchRequestBuilder addAggregations(
	 ...
	 * @return
	 */
	private SearchRequestBuilder setResultSize(
	 ...
	 * @return
	 */
	private SearchRequestBuilder addSort(SearchCriteria searchCriteria,
	...
	protected QueryBuilder getQueryBuilder(SearchCriteria searchCriteria,
		...
		String queryString = searchCriteria.getAdvancedQuery();
		...
		if (types != null && !types.isEmpty()) {
			...
			if (StringUtils.isBlank(queryString)) {
				...
				matchQueryBuilder = QueryBuilders.multiMatchQuery(queryString,searchFiledsArray)
