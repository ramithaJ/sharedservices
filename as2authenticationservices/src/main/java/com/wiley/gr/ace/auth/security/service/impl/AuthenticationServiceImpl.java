...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public Response userLogin(final AuthenticateRequest request) {
        ...
        Response lockResponse = validateLockTime(request, response, lockedAccountDetails);
     ...
     * @return
     */
    private Response validateLockTime(AuthenticateRequest request, Response response, LockedAccountDetails lockedAccountDetails) {
     ...
     * @return
     */
    private Response failedAttempts(AuthenticateRequest request, Response response) {
     ...
     * @return
     */
    private Response activeDirectoryUsers(String userId, String password, String authenticationType, String appKey) {
     ...
     * @return
     */
    private Response checkUserUnlockCondition(AuthenticateRequest request, LockedAccountDetails lockedAccountDetails) {
        //if user is Locked
